"""
Django settings for kidslearning project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'cvsukidslearning.pythonanywhere.com']
...
ROOT_URLCONF = 'kidslearning.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'kidslearning.context_processors.global_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'kidslearning.wsgi.application'
